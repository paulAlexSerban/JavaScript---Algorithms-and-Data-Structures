 ...
 * 
 * For example, a = [1, 2, 3] and b = [3, 2, 1]. For elements 0, Bob is awarded a point because a[0] < b[0]. For the equal elements a[1] and b[1], no points are earned.
 ...
 * 
 * Return
 * - an array of two integers denoting the respective comparison points earned by Alice and Bob.
 * 
 * Input Format
