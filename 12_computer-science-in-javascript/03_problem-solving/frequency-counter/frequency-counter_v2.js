...
const same = (arr1, arr2) => {
  ...
  for (let key in frequentCounter1) {
    if (!(key ** 2 in frequentCounter2)) { // 3
      return false;
    }

    if (frequentCounter2[key ** 2] !== frequentCounter1[key]) { // 4
      return false;
    }
  }
  return false;
...
console.log(
  same(
    ...
    [
      4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1,
      9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4,
      1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9,
      4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1,
      9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4,
      1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9,
      4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1, 9, 4, 1,
