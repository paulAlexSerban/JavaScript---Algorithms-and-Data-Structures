 ...
 * only the elements for which that function returns a truthy value - that is, a value
 * which returns true if passed to the Boolean() constructor. In other words, it filters
