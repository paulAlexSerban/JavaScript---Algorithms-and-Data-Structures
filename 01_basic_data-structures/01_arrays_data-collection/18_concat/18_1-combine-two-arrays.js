 ...
 * for both strings and arrays that work in the same way. For arrays, the method 
 * is called on one, then another array is provided as the argument to concat, which 
 * is added to the end of the first array. It returns a new array and does not mutate 
